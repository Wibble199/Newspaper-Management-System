...
// This is a slightly edited version of the plugin
...
(function ($) {
	...
	$.fn.extend({
		...
		// Quick, dirty hack to make it possible to reload the current events
		...
		function setMonthly(month, year) {
			if (month === undefined) month = $(parent).data("setMonth");
			else $(parent).data("setMonth", month);

			if (year === undefined) year = $(parent).data("setYear");
			else $(parent).data("setYear", year);
